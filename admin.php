<?php
// 1. WAJIB: Memulai sesi agar bisa mengakses $_SESSION
session_start();

// 2. Menyertakan file koneksi.php
include "koneksi.php";

// 2. CEK KEAMANAN: Periksa apakah user sudah login
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <a class="navbar-brand" target="_blank" href=".">Olahraga Meredakan Stres</a>
        <button
    ...
    <footer class="text-center p-3 bg-danger-subtle">
			<div>
				...
				<a href="https://wa.me/+6282111794900"><i class="bi bi-whatsapp h2 p-2 text-dark"></i></a>
			</div>
			<div>Rafy Wildan Falevi &copy; 2025</div>
    </footer>
    <!-- footer end -->
